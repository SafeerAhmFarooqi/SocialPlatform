                          ...
                          <div class="dropdown ms-auto">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="bdayActionEdit">
                              ...
                              <li><span class="dropdown-item">
                                {!! QrCode::size(500)->generate(route('user.dashboard.voucher.use.page',[urlencode(Illuminate\Support\Facades\Crypt::encryptString(Auth::user()->email)),urlencode(Illuminate\Support\Facades\Crypt::encryptString($unusedVoucher->code))])); !!} 
                              </span></li>
