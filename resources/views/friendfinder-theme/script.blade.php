<!-- Scripts
    ...
    <script src="{{asset('assets/FriendFinder-Theme/js/jquery.sticky-kit.min.js')}}"></script>
    <script src="{{asset('assets/FriendFinder-Theme/js/jquery.scrollbar.min.js')}}"></script>
