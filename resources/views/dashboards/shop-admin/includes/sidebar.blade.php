...
<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link" href="#">
                                ...
                                <span class="menu-title">Edit General Settings</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="#">
                                ...
                                <span class="menu-title">Edit Home Page</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="#">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="#">
                                ...
                                <span class="menu-title">Edit Terms and Conditions</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="#">
                                ...
                                <span class="menu-title">Edit Privacy Policy</span>
                            </a>
                        </div>
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    <span class="menu-link">
                        ...
                        <span class="menu-title">Manage Proposals</span>
                        <span class="menu-arrow"></span>
                    </span>
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="#">
                                ...
                                <span class="menu-title">Calculator Fields</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="#">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="#">
                                ...
                                <span class="menu-title">Proposals Requests</span>
                            </a>
                        </div>
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="#">
                                ...
                                <span class="menu-title">My Proposals</span>
                            </a>
                        </div>
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    <span class="menu-link">
                        ...
                        <span class="menu-title">Hub</span>
                        <span class="menu-arrow"></span>
                    </span>
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
    ...
    <div class="aside-footer flex-column-auto pt-5 pb-7 px-5" id="kt_aside_footer">
        <a href="#" class="btn btn-custom btn-primary w-100" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" title="">
            <span class="btn-label">greenroom</span>
