    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <div class="nav mt-3 mt-lg-0 flex-nowrap align-items-center px-4 px-lg-0">
          <div class="nav-item w-100">
            <form class="rounded position-relative" action="{{route('user.dashboard.users.page')}}" method="get">
              <input class="form-control ps-5 bg-light" type="search" placeholder="Search...saf" aria-label="Search" name="search">
      ...
      <ul class="nav flex-nowrap align-items-center ms-sm-3 list-unstyled">
        <li class="nav-item ms-2">
          <a class="nav-link icon-md btn btn-light p-0" href="{{route(config('chatify.routes.prefix'))}}">
            <i class="bi bi-chat-left-text-fill fs-6"> </i>
          </a>
        </li>
        <li class="nav-item ms-2">
          <a class="nav-link icon-md btn btn-light p-0" href="{{route('user.profile.basic.show')}}">
