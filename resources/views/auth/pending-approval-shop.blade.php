...
@section('body-content')
	  ...
	  <div class="sign-up-form">
				  ...
				  <div class="form-wrapper">
					  <p class="signup-text">Thanks for signing up! Before getting started, your shop account must be approved from Administrator. Please wait until your account is approved.</p>
